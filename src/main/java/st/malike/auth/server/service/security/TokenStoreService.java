...
public class TokenStoreService implements TokenStore {
    ...
    @Autowired
    private OAuth2AccessTokenRepositoryCustom oAuth2AccessTokenRepository;
    @Autowired
    private OAuth2RefreshTokenRepositoryCustom oAuth2RefreshTokenRepository;
//    @Autowired
//    private MongoTemplate mongoTemplate;
    ...
    public OAuth2RefreshToken readRefreshToken(String accessToken) {
        ...
        OAuth2AuthenticationRefreshToken token = null;
    ...
    public OAuth2Authentication readAuthenticationForRefreshToken(OAuth2RefreshToken token) {
        ...
        OAuth2AuthenticationRefreshToken auth2AuthenticationRefreshToken = null;
    ...
    public Collection<OAuth2AccessToken> findTokensByClientId(String clientId) {
        ...
        List<OAuth2AuthenticationAccessToken> accessTokens = null;
